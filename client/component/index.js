...
export default class Sidebar extends React.Component {
  ...
  render() {
    ...
    const projectIcon = store.redux.state('app.settings.decoration.main.project_icon') || DEFAULT_PROJECT_ICON
        ...
        <div className="section-left">
          <div className="section-left-top">
            <div style={{ position: 'relative', marginBottom: 20 }}>
              <div classNmame="project-icon-wrapper" style={{ width: 40, height: 40 }}>
                <img className="project-icon" style={{ width: '100%', height: '100%', padding: 2 }} src={projectIcon} alt="" />
              </div>
              {
                !this.state.open && (
